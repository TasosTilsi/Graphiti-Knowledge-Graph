...
Use tmp_path fixture for queue storage.
  ...
  <done>Client tests verify failover and retry logic. Quota tests verify tracking. Queue tests verify persistence.</done>
</task>
...
3. **Use monkeypatch for:**
  ...
  <done>Integration tests verify complete LLM flow with mocked services.</done>
</task>
